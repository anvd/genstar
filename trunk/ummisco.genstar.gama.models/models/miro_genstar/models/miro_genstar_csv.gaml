...
global {
	...
	init {
		...
		list miro_population <- population_from_csv('../includes/population/MIRO_Attributes_MetaData.csv', '../includes/population/MIRO_GenerationRules_MetaData.csv', nb_of_people);
