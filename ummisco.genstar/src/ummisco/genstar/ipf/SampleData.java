...
//	private SampleEntityPopulation sampleEntityPopulation;
	...
	// TODO refactor this method for re-use when parsing sample data file and population file
	private void initializeSampleEntities() throws GenstarException {
		this.sampleEntityPopulation = new Population(PopulationType.SAMPLE_DATA_POPULATION, populationName, attributes);
...
//		sampleEntityPopulation.createEntities(sampleEntitiesAttributeValues);
		sampleEntityPopulation.createEntitiesWithAttributeValuesOnEntities(sampleEntitiesAttributeValues);
	}
