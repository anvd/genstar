...
public class FrequencyDistributionPopulationGenerator1 {

	public FrequencyDistributionPopulationGenerator1() {}
	
	public static void main(String[] args) throws Exception {
		String propertiesFilePath = "example_data/FrequencyDistributionPopulationGenerator1/HouseholdPopulation_Experiment_1.properties";
		...
		GenstarCsvFile householdGenerationRulesFile = new GenstarCsvFile("example_data/FrequencyDistributionPopulationGenerator1/Household_GenerationRules.csv", false);
		...
		System.out.println("Open file(s) in \'example_data/FrequencyDistributionPopulationGenerator1/result_analysis/\' folder to look at the generation result analysis");
	}
}
