...
public class IpfPopulationExtractor1 {

	public IpfPopulationExtractor1() {}
	
	public static void main(String[] args) throws Exception {
		String basePath = "example_data/IpfPopulationExtractor1/";
		String[] extractorPropertiesFilePaths = {
			basePath + "ExtractedIpfPopulationProperties_without_ID_OnePercent.properties",
			basePath + "ExtractedIpfPopulationProperties_without_ID_TenPercents.properties",
			basePath + "ExtractedIpfPopulationProperties_without_ID_ThirtyPercents.properties"
		};
