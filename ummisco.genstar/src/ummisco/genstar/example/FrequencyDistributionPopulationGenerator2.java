...
public class FrequencyDistributionPopulationGenerator2 {

	
	public FrequencyDistributionPopulationGenerator2() {}
	
	public static void main(String[] args) throws Exception {
		String propertiesFilePath = "example_data/FrequencyDistributionPopulationGenerator2/HouseholdPopulation_Experiment_2.properties";
		...
		GenstarCsvFile householdGenerationRulesFile = new GenstarCsvFile("example_data/FrequencyDistributionPopulationGenerator2/Household_GenerationRules.csv", false);
		...
		System.out.println("Open file(s) in \'example_data/FrequencyDistributionPopulationGenerator2/result_analysis/\' folder to look at the generation result analysis");
	}
