...
public class IpfPopulationGenerator5 {

	public IpfPopulationGenerator5() {}
	
	public static void main(String[] args) throws Exception {
		String propertiesFilePath = "example_data/IpfPopulationGenerator5/ipf_configuration.properties";
		...
		System.out.println("Open file(s) in \'example_data/IpfPopulationGenerator5/RESULT_ANALYSIS_generated_group_population.csv\' folder to look at the generation result analysis");
	}
}
