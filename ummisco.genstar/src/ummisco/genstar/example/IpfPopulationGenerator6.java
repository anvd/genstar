...
public class IpfPopulationGenerator6 {

	public IpfPopulationGenerator6() {}
	
	public static void main(String[] args) throws Exception {
		String propertiesFilePath = "example_data/IpfPopulationGenerator6/ipf_configuration_10iterations.properties";
		...
		System.out.println("Open file(s) in \'example_data/IpfPopulationGenerator6/RESULT_ANALYSIS_generated_group_population.csv\' folder to look at the generation result analysis");
	}
