 ...
 */
public class GSAliasSample implements IGSSampler<ACoordinate<AbstractAttribute, AttributeValue>> {
	 ...
	 */
	public GSAliasSample(List<Double> probabilities, List<ACoordinate<AbstractAttribute, AttributeValue>> indexedKey) {
		this(probabilities, indexedKey, new Random());
	}
	 ...
	 */
	public GSAliasSample(List<Double> probabilities, List<ACoordinate<AbstractAttribute,AttributeValue>> indexedKey, Random random) {
