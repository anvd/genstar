...
public class GenstarCsvFileTest {
	...
	public void testValidCSVFilePath() throws GenstarException {
		GenstarCsvFile csvFile = new GenstarCsvFile("test_data/ummisco/genstar/util/GenstarCSVFile/testValidCSVFilePath/people_sample.csv", true);
	...
	public void testGetRowWithHeaders() throws GenstarException {
		GenstarCsvFile csvFile = new GenstarCsvFile("test_data/ummisco/genstar/util/GenstarCSVFile/testGetRowWithHeaders/people_sample.csv", true);
	...
	public void testGetRowWithoutHeaders() throws GenstarException {
		GenstarCsvFile csvFile = new GenstarCsvFile("test_data/ummisco/genstar/util/GenstarCSVFile/testGetRowWithoutHeaders/people_sample_without_headers.csv", false);
	...
	@Test public void testGetContent() throws GenstarException {
		GenstarCsvFile csvFile = new GenstarCsvFile("test_data/ummisco/genstar/util/GenstarCSVFile/testGetContent/people_sample.csv", true);
		...
		csvFile = new GenstarCsvFile("test_data/ummisco/genstar/util/GenstarCSVFile/testGetRowWithHeaders/people_sample_without_headers.csv", false);
