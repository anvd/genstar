...
public class UniqueValueTest {
	...
	@Test public void testCompareTo() throws GenstarException {
		UniqueValue v0 = new UniqueValue(ValueType.INTEGER, "0");
		UniqueValue v1 = new UniqueValue(ValueType.INTEGER, "0");
		UniqueValue v2 = new UniqueValue(ValueType.INTEGER, "1");
	...
	@Test public void testIsMatchValue() throws GenstarException {
		UniqueValue v1 = new UniqueValue(ValueType.INTEGER, "1");
		UniqueValue v2 = new UniqueValue(ValueType.INTEGER, "1");
		UniqueValue v3 = new UniqueValue(ValueType.INTEGER, "2");
		
		
		UniqueValue v4 = new UniqueValue(ValueType.INTEGER, "1");
		UniqueValue v5 = new UniqueValue(ValueType.INTEGER, "1");
		UniqueValue v6 = new UniqueValue(ValueType.INTEGER, "2");
		
		
		RangeValue v7 = new RangeValue(ValueType.INTEGER, "1", "2");
		RangeValue v8 = new RangeValue(ValueType.INTEGER, "1", "2");
		RangeValue v9 = new RangeValue(ValueType.INTEGER, "2", "3");
		
		
		RangeValue v10 = new RangeValue(ValueType.FLOAT, "1", "2");
		RangeValue v11 = new RangeValue(ValueType.FLOAT, "1", "2");
		RangeValue v12 = new RangeValue(ValueType.FLOAT, "2", "3");
		
		
		UniqueValue v13 = new UniqueValue(ValueType.STRING, "1");
		UniqueValue v14 = new UniqueValue(ValueType.STRING, "1");
		UniqueValue v15 = new UniqueValue(ValueType.STRING, "2");
